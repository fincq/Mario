"""HTTP client for Tassomai API interactions."""
...
class TassomaiClient:
    ...
    def refresh_token(self) -> None:
        ...
        response = self._request(
            ...
            headers=self._auth_headers(accept_version=True, full_headers=True),
        )
        if not isinstance(response, Mapping):
    ...
    def get_quizzes(self, subject_id: str) -> Iterable[Mapping[str, Any]]:
        ...
        payload = self._request("GET", endpoint, params=params, headers=self._auth_headers(accept_version=True))
    ...
    def fetch_quiz(self, course_id: str, playlist_id: str) -> Mapping[str, Any]:
        ...
        response = self._request("POST", "/quiz/", json_payload=payload, headers=self._auth_headers(accept_version=True))
